...
{
	if (region.aC._ === region.aR._)
	{
		return 'on line ' + region.aC._;
	}
	return 'on lines ' + region.aC._ + ' through ' + region.aR._;
}
...
var $author$project$VerifyExamples$MarkdownSource = F2(
	function (fileName, fileText) {
		return {aV: fileName, af: fileText};
	});
...
var $author$project$VerifyExamples$Elm$addSourceImport = F2(
	function (moduleName, testSuite) {
		...
		return _Utils_update(
			testSuite,
			{
				ah: A2($elm$core$List$cons, sourceImport, testSuite.ah)
			});
	});
...
var $author$project$VerifyExamples$Test$specBody = function (_v0) {
	var assertion = _v0.aJ;
	var expectation = _v0.aT;
	return $author$project$String$Util$unlines(
		_List_fromArray(
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {b0: index, b5: match, ch: number, cr: submatches};
	});
...
var $author$project$VerifyExamples$Function$toString = function (_v0) {
	var _function = _v0.aX;
	return _function;
};
var $author$project$VerifyExamples$Compiler$compileTest = F4(
	function (nomenclature, suite, index, test) {
		var testName = nomenclature.bw(test);
		var testModuleName = A2(nomenclature.bv, index, test);
			...
			$author$project$String$Util$unlines(
				_List_fromArray(
					[
						...
						$author$project$String$Util$unlines(suite.an),
						'',
						$author$project$String$Util$unlines(
						A2($elm$core$List$map, $author$project$VerifyExamples$Function$toString, suite.bZ)),
						'',
...
var $author$project$VerifyExamples$Elm$compile = F2(
	function (moduleName, testSuite) {
		return A2(
			...
			{
				bv: $author$project$VerifyExamples$Elm$Nomenclature$testModuleName(moduleName),
				bw: $author$project$VerifyExamples$Elm$Nomenclature$testName
			},
...
var $author$project$VerifyExamples$Warning$Ignored$all = F2(
	function (warning, ignores) {
		var _v0 = A2(
			$elm$core$List$filter,
			function (ignored) {
				return _Utils_eq(ignored.a8, $elm$core$Maybe$Nothing);
			},
			A2(
				$elm$core$List$filter,
				function (_v1) {
...
var $author$project$VerifyExamples$Warning$warnings = F2(
	function (ignored, _v0) {
		var exposedApi = _v0.aU;
		var testSuites = _v0.bx;
		return A2(
			$elm$core$List$filter,
...
var $author$project$VerifyExamples$compileElm = F2(
	function (_v0, parsed) {
		var moduleName = _v0.aw;
		var ignoredWarnings = _v0.a2;
		return _Utils_Tuple2(
...
var $author$project$VerifyExamples$Markdown$compile = F2(
	function (filePath, _v0) {
		...
		return A2(
			$author$project$VerifyExamples$Compiler$compile,
			{
				bv: A2($author$project$VerifyExamples$Markdown$testModuleName, suiteIndex, filePath),
				bw: function (test) {
...
var $author$project$VerifyExamples$compileMarkdown = F2(
	function (_v0, parsed) {
		...
		return A2(
			...
			A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, parsed.bx));
	});
...
var $author$project$VerifyExamples$noExamples = _Platform_outgoingPort(
	'noExamples',
	function ($) {
...
var $author$project$VerifyExamples$generateTests = function (tests) {
	if (!tests.b) {
		return $author$project$VerifyExamples$noExamples(0);
	} else {
		...
		if (matches.b.b.a.$ === 1) {
			...
			return $elm$core$Maybe$Just(
				$author$project$VerifyExamples$Elm$Snippet$FunctionDoc(
					{
						ar: functionName,
						aB: $author$project$VerifyExamples$Elm$Snippet$cleanComment(comment)
					}));
		}
	} else {
		return $elm$core$Maybe$Nothing;
...
var $author$project$VerifyExamples$Ast$Grouped$empty = {ae: _List_Nil, ag: _List_Nil, ah: _List_Nil, an: _List_Nil};
					...
					case 2:
						...
						return A2(
							...
							function (x) {
								...
								A2($elm$core$List$cons, str, acc.ah)));
					case 4:
						var str = ast.a.a;
						var rest = ast.b;
						return A2(
							...
							function (x) {
								...
								A2($elm$core$List$cons, str, acc.an)));
					default:
						var _v2 = ast.a;
						var name = _v2.a;
						var str = _v2.b;
...
var $author$project$VerifyExamples$Test$fromExamples = function (functionToTest) {
	return $elm$core$List$map(
		function (_v0) {
			var assertion = _v0.aJ;
			var expectation = _v0.aT;
			return {aJ: assertion, aT: expectation, aY: functionToTest};
		});
};
...
var $author$project$VerifyExamples$Function$isUsedInExample = F2(
	function (_v0, _v1) {
		var name = _v0.a8;
		var assertion = _v1.aJ;
		var expectation = _v1.aT;
...
var $author$project$VerifyExamples$TestSuite$fromAst = F2(
	function (fnName, _v0) {
		var imports = _v0.ah;
		var types = _v0.an;
		var functions = _v0.ag;
		var examples = _v0.ae;
		return {
			bZ: A2($author$project$VerifyExamples$Function$toFunctions, examples, functions),
			ah: A2($elm$core$List$map, $author$project$VerifyExamples$Ast$Grouped$importToString, imports),
			cv: A2($author$project$VerifyExamples$Test$fromExamples, fnName, examples),
			an: A2($elm$core$List$map, $author$project$VerifyExamples$Ast$Grouped$typeToString, types)
		};
	});
...
var $author$project$VerifyExamples$Elm$toTestSuite = function (snip) {
	if (!snip.$) {
		...
		return $author$project$VerifyExamples$Parser$parse(
			{ar: $elm$core$Maybe$Nothing, aB: snippet});
	} else {
		var snippet = snip.a.aB;
		var functionName = snip.a.ar;
		return $author$project$VerifyExamples$Parser$parse(
			{
				ar: $elm$core$Maybe$Just(functionName),
				aB: snippet
			});
	}
};
var $author$project$VerifyExamples$Elm$parse = function (fileText) {
	return {
		aU: $author$project$VerifyExamples$Elm$ExposedApi$parse(fileText),
		bx: A2(
			$elm$core$List$map,
				...
				return $elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							...
							A2($author$project$VerifyExamples$reportWarnings, source.aw, warnings)
						]));
			}(
				A2(
					$author$project$VerifyExamples$compileElm,
					source,
					$author$project$VerifyExamples$Elm$parse(source.af)));
		case 2:
			var source = msg.a;
			return $author$project$VerifyExamples$generateTests(
				A2(
					...
					source,
					$author$project$VerifyExamples$Markdown$parse(source.af)));
		default:
			var err = msg.a;
			return $author$project$VerifyExamples$reportError(
				$elm$json$Json$Encode$string(
...
var $author$project$VerifyExamples$main = $elm$core$Platform$worker(
	{
		...
		cs: $author$project$VerifyExamples$subscriptions,
		cy: F2(
			function (msg, _v0) {
				return _Utils_Tuple2(
					0,
